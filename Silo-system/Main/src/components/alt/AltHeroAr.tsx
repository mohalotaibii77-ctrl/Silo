...
const words = ["أذكى", "أسرع", "أفضل", "تلقائياً"];

export default function AltHeroAr() {
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-40 pb-32">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          {/* Right column (RTL) - Main headline */}
          <div className="lg:col-span-8">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-8">
                ...
                />
                <span
                  className="text-sm font-medium tracking-wide text-gray-500 dark:text-zinc-500"
              ...
              <h1
                className="text-[clamp(3rem,8vw,7rem)] font-bold leading-[1.4] tracking-tight text-black dark:text-white mb-8"
                style={{ fontFamily: "IBM Plex Sans Arabic, Tajawal, sans-serif" }}
              >
                <motion.span
                ...
                >
                  <span className="relative inline-block overflow-hidden h-[1.45em] align-bottom min-w-[6ch]">
            ...
            <motion.p
              ...
              style={{ fontFamily: "IBM Plex Sans Arabic, Tajawal, sans-serif" }}
            >
              اجمع نقاط البيع، المخزون، الموارد البشرية، المحاسبة، والعمليات
              في منصة ذكية واحدة. اتخذ قرارات مبنية على البيانات مع
            ...
            >
              ...
              >
                ...
                <ArrowUpLeft className="w-5 h-5 relative z-10 group-hover:-translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                <motion.div
      ...
      >
        <span
          className="text-xs tracking-wide text-gray-400 dark:text-zinc-600"
          style={{ fontFamily: "IBM Plex Sans Arabic, Tajawal, sans-serif" }}
        >
          مرر للأسفل
        </span>
