    ...
    <View style={styles.container}>
      ...
      <View style={[styles.header, isRTL && styles.headerRTL]}>
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>{t('bundles', 'Bundles')}</Text>
          <Text style={styles.headerSubtitle}>{t('productBundlesSoldTogether', 'Product bundles sold together')}</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  inactiveBadge: {
    ...
    left: 8,
    right: 8,
    backgroundColor: colors.textSecondary + 'E0',
    paddingVertical: 4,
    borderRadius: 6,
    alignItems: 'center',
  },
