    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.headerSubtitle}>Employee Terminal</Text>
        </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            <MenuItem icon={PackageSearch} title="Check Inventory" />
            <View style={styles.divider} />
            <MenuItem icon={Clock} title="Time Clock" subtitle="Clock in/out" />
          </View>
        </View>
      </ScrollView>
    </View>
